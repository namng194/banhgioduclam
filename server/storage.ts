...
// Standalone chatbot logic that doesn't require database
// This is used as fallback when database is unavailable
export function getChatbotAnswer(questionQuery: string): string {
